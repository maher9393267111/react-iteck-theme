          ...
          <div className="col-lg-7">
            <div className="cont text-center">
              ...
              */}
              <h1>
                {" "}
                Software & Technology <br /> HTML Template{" "}
              </h1>
              <a
                href="#demos"
                className="btn rounded-pill bg-white fw-bold color-darkBlue mt-50 me-2"
              >
                <small className="text-uppercase"> all demos </small>
              </a>
              <a
                href={appData.itemStoreLink}
        ...
        <div id="js-scene" data-invert-y="true" data-invert-x="true">
          <div className="imgs one">
            {scenes.scene1.one.map((scene, i) => (
              <div
                className={`top ${scene.class} layer`}
