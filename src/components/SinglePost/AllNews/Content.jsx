...
const Content = ({ style, rtl }) => {
  return (
    <>
      <h4 className="fw-bold color-000 lh-4 mb-30">{ 'To mark the first UK show of artist Henri Barande, developer' } <a href="#" className={`color-blue${style}`}>{ rtl ? 'موسي' : 'Moussa' }</a> {'and German studio Schultzschultz  have created The Lodge Wooden at Berlin City' }</h4>
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="img text-center mt-30">
              ...
              <span className="color-999 fs-12px mt-20">{ 'Images by' } <a href="#" className="color-000">{ rtl ? '@مثال' : '@sample' }</a> </span>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="img text-center mt-30">
